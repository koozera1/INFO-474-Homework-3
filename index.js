  ...
  function plotData(map) {
    ...
    var dot = svgContainer.selectAll('.dot')
      ...
      .append('circle')
        ...
        // make drop down for year
        var dropDownYear = d3.select("#filter").append("select")
          .attr("name", "time");

        var optionsYear = dropDownYear.selectAll("option")
        ...
        optionsYear.text(function (d) { return d; })
